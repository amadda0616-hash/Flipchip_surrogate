...
# 5. 📈 플립칩(Flip-Chip) 패키지 열변형 3-Step 시나리오 프로파일
...
# 10. 📊 6-Dimension Geometric Parameter 정의서
...
## 📌 11. 프로젝트 사전 정보 (Project Context & Meta-Data)
...
### 11.3. 데이터 결측치 (Missing Data / Infeasibility)
